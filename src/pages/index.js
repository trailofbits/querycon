    ...
    return (
      <div className={styles.pageWrapper}>
        ...
        <p className={styles.leader}>
          ...
          <strong>Palace of Fine Arts Innovation Hangar</strong> focused on
          bringing security, devops, macadmins, and other experts in the osquery
          community together. With talks from industry juggernauts and the{' '}
          <strong>creators of osquery</strong>, discussion will focus on
          emergent topics that affect the landscape {`&`} development of
          osquery.
        </p>
        ...
        <div className={styles.reserveSub}>
        ...
        <div className={styles.passFeatures}>
          ...
          <FeatureTile title="After Hours Cocktail Party" url="">
            ...
            contributors, speakers, and other conference goers at this
            attendee-only networking event. Classic cocktails and delicious
            appetizers are on us! Location to be announced soon.
          </FeatureTile>
        ...
        <p className={styles.venueDescription}>
          QueryCon18 will be held at the Palace of the Fine Arts Innovation
          Hangar, minutes away from the Golden Gate Bridge. Parking will be
          validated for all conference goers.
        </p>
        ...
        <div className={styles.preConfMain}>
          ...
          <div className={styles.preConfMainText}>
            ...
            <p className={styles.preConfMainDescription}>
              ...
              response tool. It supports 10 OS flavors and is continuously built
              for 8 of those. It is very important that the infrastructure used
              to test, build, and publish security software be secure itself.
              This discussion presents how our Security team has enabled any
              Github contributor to submit C/C++/bash code to our CI and build
              server, safely. We will guide the audience through our CI
              hardening process and the attack and vulnerability reports we have
              received through our bug bounty targeting CI. This includes
              isolating a Mac Mini fleet of build slaves, not trusting Jenkins
              as much as possible, automatically building, signing, and
              publishing packages to AWS S3, doing the same for OS X kernel
              extension code, adding 2-factor to everything.
            </p>
          </div>
        </div>
        ...
        <div className={styles.sectionSubheader}>
          {`We're`} here to answer whatever you would like to know about
          QueryCon. Please see the FAQ and {`don't`} hesitate to contact us if
